$(document).ready(function() {
  function e(e) {
      e.element;
      return e.id ? "<i class='material-icons'>" + $(e.element).data("icon") + "</i>" + e.text : e.text
  }
  $(".select2").select2({
      dropdownAutoWidth: !0,
      width: "100%"
  ...
  $(".select2-data-array").select2({
      ...
      templateResult: function(e) {
          ...
          return t += "<div class='select2-result-repository__statistics'><div class='select2-result-repository__forks'><i class='icon-code-fork mr-0'></i> " + e.forks_count + " Forks</div><div class='select2-result-repository__stargazers'><i class='icon-star5 mr-0'></i> " + e.stargazers_count + " Stars</div><div class='select2-result-repository__watchers'><i class='icon-eye mr-0'></i> " + e.watchers_count + " Watchers</div></div></div></div>"
      },
      ...
      dropdownAutoWidth: !0,
      width: "100%",
      containerCssClass: "select-sm2"
  }), $(".select2-size-sm2").select2({
    dropdownAutoWidth: !0,
    width: "100%",
    containerCssClass: "select-lg"
  }), $(".select2-size-sm3").select2({
      dropdownAutoWidth: !0,
      width: "100%",
      containerCssClass: "select-sm3"
  })
});