    ...
    <footer class="page-footer footer footer-static footer-light navbar-border navbar-shadow">
      <div class="footer-copyright">
        <div class="container"><span>&copy; 2023 Uptimised Corporation All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="#">Ronnel Navarro</a></span></div>
      </div>
    </footer>
    <!-- END: Footer-->
    <!-- BEGIN VENDOR JS-->
    ...
    <script src="assets/vendors/form_repeater/jquery.repeater.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
    ...
    <script src="assets/js/scripts/app-invoice.min.js"></script>
    <!-- BEGIN PAGE LEVEL JS-->
